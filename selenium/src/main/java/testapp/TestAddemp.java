...
/**
 * testcases for add new employee: -------------------------------- 1.empty
 * loginName 2.empty password 3.empty firstName 4.empty dob 5.empty emp salary
 * 6.empty mobilNo 7.password < 5 8.password > 10 9.mobile < 10 10.mobile > 10
 * 11.success emp creation 12.testCase for loginName already exists
 * 
 * common: -------------- ->login ->click on 'add new employee' link -> verify
 * the screen content. ->logout -> get the web-element objects + assertions on
 * fileds
 * 
 */
public class TestAddemp extends MyEmpDemoBaseTest1 {
...
//click on "Add New Employee" link
	...
	public void addEmpolyee(String loginName, String password1, String FName, String LName, String birth, String salary,
		...
		checkEnabledAndDisplayed(emploginlabel, logname, emppwdlabel, pass, emplnanelabel, lname, designationlabel,
				design, genderlabel, sex, dateofbirthlabel, dob, statuslabel, status, departmentlabel, deptid,
				managerlabel, managerid, employesallabel, sal, mobilenolabel, cellNo, maritalstatuslabel, matrialstatus,
				acceptlabel, accept, submit);
	...
	addEmpolyee("nandu", "raju@1234", "rajvardhan", "kumar", "03/31/1992", "30000", "8899445577");
