...
import testapp.MyEmpDemoBaseTest1;
...
public class AddEmp extends BasePage {
	...
	@FindBy(tagName = "h2")
	WebElement empdata;
	@FindBy(id = "empLoginLbl")
	WebElement emploginlabel;
	@FindBy(id = "loginName")
	WebElement logname;
	@FindBy(id = "empPwdLbl")
	WebElement emppwdlabel;
	@FindBy(id = "password")
	WebElement pass;
	@FindBy(id = "empFnameLbl")
	WebElement empfnamelabel;
	@FindBy(id = "fName")
	WebElement fname;
	@FindBy(id = "empLnameLbl")
	WebElement emplnanelabel;
	@FindBy(id = "lName")
	WebElement lname;
	@FindBy(id = "desigLbl")
	...
	@FindBy(id = "department.id")
	WebElement deptid;
	@FindBy(id = "managerLbl")
	WebElement managerlabel;
	@FindBy(id = "manager.id")
	WebElement managerid;
	@FindBy(id = "empSalLbl")
	WebElement employesallabel;
	@FindBy(id = "salary")
	WebElement sal;
	@FindBy(id = "mnoLbl")
	WebElement mobilenolabel;
	@FindBy(id = "mobileNo")
	WebElement cellNo;
	@FindBy(id = "maritalStatusLbl")
	WebElement maritalstatuslabel;
	@FindBy(id = "maritalStatus")
	WebElement matrialstatus;
	@FindBy(id = "acceptLabl")
	...
	public void addEmpolyee(String loginName, String password1, String FName, String LName, String birth, String salary,
		...
		MyEmpDemoBaseTest1.checkEnabledAndDisplayed(empdata, emploginlabel, logname, emppwdlabel, pass, empfnamelabel,
				fname, emplnanelabel, lname, designationlabel, design, genderlabel, sex, dateofbirthlabel, dob,
				statuslabel, status, departmentlabel, deptid, managerlabel, managerid, employesallabel, sal,
				mobilenolabel, cellNo, maritalstatuslabel, matrialstatus, acceptlabel, accept, submit);
