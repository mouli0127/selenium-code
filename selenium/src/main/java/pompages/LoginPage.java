...
// method to perform login
	public void login(String userNameValue, String passwordValue) {
		...
		MyEmpDemoBaseTest1.checkEnabledAndDisplayed(usernamelab, passwordlab, loginBtn, password, name);
...
//logout
		...
		;
		MyEmpDemoBaseTest1.checkEnabledAndDisplayed(logout);
...
//TEST for invalid error message
		...
		MyEmpDemoBaseTest1.checkEnabledAndDisplayed(invalidlogin);
